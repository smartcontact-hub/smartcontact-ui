...
/**
 * Versión, Objetivo y Estado son obligatorios (decisión de producto, 2026-09-16): se enseñan arriba de cada tarjeta, y así ninguna
 ...
 * ocurre dentro, y la agenda no se llena de enlaces casi iguales (decisión de producto, 2026-09-22).
 */
