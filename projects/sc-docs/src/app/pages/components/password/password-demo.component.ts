...
export class PasswordDemoComponent {
  ...
  protected readonly meta: StoryMeta = {
    ...
    props: [
      ...
      { name: 'required', type: 'boolean', default: 'false', description: 'Marca y `aria-required`; no activa la validación nativa.' },
      ...
      { name: 'ariaLabel', type: 'string', default: '—', description: 'Nombre accesible sin label visible.' },
      { name: 'inputId', type: 'string', default: 'auto', description: 'id del `<input>` real.' },
      { name: 'name', type: 'string', default: '—' },
      {
        name: 'autocomplete',
        type: 'string',
        default: '—',
        description: '`current-password` en un acceso, `new-password` al crearla.',
      },
      { name: 'maxlength', type: 'number', default: '—' },
      {
        ...
        type: 'boolean',
        default: 'true',
        description: 'Botón mostrar/ocultar (Tab + Enter/Espacio).',
      },
      {
        name: 'feedback',
        type: 'boolean',
        default: 'false',
        description: 'Medidor de fuerza de PrimeNG (para crear contraseña, no para acceder).',
      },
      {
        name: 'showAriaLabel',
        type: 'string',
        default: "'Mostrar contraseña'",
        description: 'Nombre del botón con la contraseña oculta.',
      },
      {
        name: 'hideAriaLabel',
        type: 'string',
        default: "'Ocultar contraseña'",
        description: 'Nombre del botón con la contraseña visible.',
      },
