 ...
 * pasaron a `sc-tag` / `sc-badge` en el mismo cambio. La última, el icono enmarcado del hub de
 * Repositorios, era solo lo que la sonda veía de una FILA de navegación hecha a mano entera: se fue
 * cuando la fila pasó al `Menu` del DS (DD-78), no migrando el icono suelto.
 *
 * Vacío = ninguna pantalla dibuja pastillas propias. Una clave nueva aquí necesita al lado su porqué.
 */
