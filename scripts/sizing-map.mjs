...
export const SIZING = [
  ...
  // ── DD-86 (2026-09-14), segunda tanda: rellenos y márgenes compuestos («arriba y lados») y tamaños de letra
  //    que los temas escribían con pasos de escala y ya valían lo mismo que el Kit.
  { label: 'accordion.content.paddingTop', group: 'CC', exp: 'accordion.content.padding.top', read: { path: 'components.accordion.content.padding', index: 0 } },
  { label: 'accordion.content.paddingRight', group: 'CC', exp: 'accordion.content.padding.right', read: { path: 'components.accordion.content.padding', index: 1 } },
  { label: 'accordion.content.paddingBottom', group: 'CC', exp: 'accordion.content.padding.bottom', read: { path: 'components.accordion.content.padding', index: 2 } },
  { label: 'accordion.content.paddingLeft', group: 'CC', exp: 'accordion.content.padding.left', read: { path: 'components.accordion.content.padding', index: 3 } },
  { label: 'avatar.root.fontSize', group: 'CC', exp: 'avatar.font.size', read: { path: 'components.avatar.root.fontSize' } },
  { label: 'avatar.lg.fontSize', group: 'CC', exp: 'avatar.lg.font.size', read: { path: 'components.avatar.lg.fontSize' } },
  { label: 'avatar.xl.fontSize', group: 'CC', exp: 'avatar.xl.font.size', read: { path: 'components.avatar.xl.fontSize' } },
  { label: 'badge.root.paddingY', group: 'CC', exp: 'badge.padding.y', read: { path: 'components.badge.root.padding', index: 0 } },
  { label: 'badge.root.paddingX', group: 'CC', exp: 'badge.padding.x', read: { path: 'components.badge.root.padding', index: 1 } },
  { label: 'badge.root.fontSize', group: 'CC', exp: 'badge.font.size', read: { path: 'components.badge.root.fontSize' } },
  { label: 'badge.sm.fontSize', group: 'CC', exp: 'badge.sm.font.size', read: { path: 'components.badge.sm.fontSize' } },
  { label: 'badge.lg.fontSize', group: 'CC', exp: 'badge.lg.font.size', read: { path: 'components.badge.lg.fontSize' } },
  { label: 'badge.xl.fontSize', group: 'CC', exp: 'badge.xl.font.size', read: { path: 'components.badge.xl.fontSize' } },
  { label: 'contextmenu.item.paddingY', group: 'CC', exp: 'contextmenu.item.padding.y', read: { path: 'components.contextmenu.item.padding', index: 0 } },
  { label: 'contextmenu.item.paddingX', group: 'CC', exp: 'contextmenu.item.padding.x', read: { path: 'components.contextmenu.item.padding', index: 1 } },
  { label: 'dataview.header.paddingY', group: 'CC', exp: 'dataview.header.padding.y', read: { path: 'components.dataview.header.padding', index: 0 } },
  { label: 'dataview.header.paddingX', group: 'CC', exp: 'dataview.header.padding.x', read: { path: 'components.dataview.header.padding', index: 1 } },
  { label: 'dataview.footer.paddingY', group: 'CC', exp: 'dataview.footer.padding.y', read: { path: 'components.dataview.footer.padding', index: 0 } },
  { label: 'dataview.footer.paddingX', group: 'CC', exp: 'dataview.footer.padding.x', read: { path: 'components.dataview.footer.padding', index: 1 } },
  { label: 'datepicker.header.paddingTop', group: 'CC', exp: 'datepicker.header.padding.top', read: { path: 'components.datepicker.header.padding', index: 0 } },
  { label: 'datepicker.header.paddingRight', group: 'CC', exp: 'datepicker.header.padding.right', read: { path: 'components.datepicker.header.padding', index: 1 } },
  { label: 'datepicker.header.paddingBottom', group: 'CC', exp: 'datepicker.header.padding.bottom', read: { path: 'components.datepicker.header.padding', index: 2 } },
  { label: 'datepicker.header.paddingLeft', group: 'CC', exp: 'datepicker.header.padding.left', read: { path: 'components.datepicker.header.padding', index: 3 } },
  { label: 'datepicker.selectMonth.paddingY', group: 'CC', exp: 'datepicker.select.month.padding.y', read: { path: 'components.datepicker.selectMonth.padding', index: 0 } },
  { label: 'datepicker.selectMonth.paddingX', group: 'CC', exp: 'datepicker.select.month.padding.x', read: { path: 'components.datepicker.selectMonth.padding', index: 1 } },
  { label: 'datepicker.selectYear.paddingY', group: 'CC', exp: 'datepicker.select.year.padding.y', read: { path: 'components.datepicker.selectYear.padding', index: 0 } },
  { label: 'datepicker.selectYear.paddingX', group: 'CC', exp: 'datepicker.select.year.padding.x', read: { path: 'components.datepicker.selectYear.padding', index: 1 } },
  { label: 'datepicker.dayView.marginTop', group: 'CC', exp: 'datepicker.day.view.margin.top', read: { path: 'components.datepicker.dayView.margin', index: 0 } },
  { label: 'datepicker.dayView.marginRight', group: 'CC', exp: 'datepicker.day.view.margin.right', read: { path: 'components.datepicker.dayView.margin', index: 1 } },
  { label: 'datepicker.dayView.marginBottom', group: 'CC', exp: 'datepicker.day.view.margin.bottom', read: { path: 'components.datepicker.dayView.margin', index: 2 } },
  { label: 'datepicker.dayView.marginLeft', group: 'CC', exp: 'datepicker.day.view.margin.left', read: { path: 'components.datepicker.dayView.margin', index: 3 } },
  { label: 'datepicker.monthView.marginTop', group: 'CC', exp: 'datepicker.month.view.margin.top', read: { path: 'components.datepicker.monthView.margin', index: 0 } },
  { label: 'datepicker.monthView.marginRight', group: 'CC', exp: 'datepicker.month.view.margin.right', read: { path: 'components.datepicker.monthView.margin', index: 1 } },
  { label: 'datepicker.monthView.marginBottom', group: 'CC', exp: 'datepicker.month.view.margin.bottom', read: { path: 'components.datepicker.monthView.margin', index: 2 } },
  { label: 'datepicker.monthView.marginLeft', group: 'CC', exp: 'datepicker.month.view.margin.left', read: { path: 'components.datepicker.monthView.margin', index: 3 } },
  { label: 'datepicker.yearView.marginTop', group: 'CC', exp: 'datepicker.year.view.margin.top', read: { path: 'components.datepicker.yearView.margin', index: 0 } },
  { label: 'datepicker.yearView.marginRight', group: 'CC', exp: 'datepicker.year.view.margin.right', read: { path: 'components.datepicker.yearView.margin', index: 1 } },
  { label: 'datepicker.yearView.marginBottom', group: 'CC', exp: 'datepicker.year.view.margin.bottom', read: { path: 'components.datepicker.yearView.margin', index: 2 } },
  { label: 'datepicker.yearView.marginLeft', group: 'CC', exp: 'datepicker.year.view.margin.left', read: { path: 'components.datepicker.yearView.margin', index: 3 } },
  { label: 'datepicker.buttonbar.paddingTop', group: 'CC', exp: 'datepicker.buttonbar.padding.top', read: { path: 'components.datepicker.buttonbar.padding', index: 0 } },
  { label: 'datepicker.buttonbar.paddingRight', group: 'CC', exp: 'datepicker.buttonbar.padding.right', read: { path: 'components.datepicker.buttonbar.padding', index: 1 } },
  { label: 'datepicker.buttonbar.paddingBottom', group: 'CC', exp: 'datepicker.buttonbar.padding.bottom', read: { path: 'components.datepicker.buttonbar.padding', index: 2 } },
  { label: 'datepicker.buttonbar.paddingLeft', group: 'CC', exp: 'datepicker.buttonbar.padding.left', read: { path: 'components.datepicker.buttonbar.padding', index: 3 } },
  { label: 'datepicker.timePicker.paddingTop', group: 'CC', exp: 'datepicker.time.picker.padding.top', read: { path: 'components.datepicker.timePicker.padding', index: 0 } },
  { label: 'datepicker.timePicker.paddingRight', group: 'CC', exp: 'datepicker.time.picker.padding.right', read: { path: 'components.datepicker.timePicker.padding', index: 1 } },
  { label: 'datepicker.timePicker.paddingBottom', group: 'CC', exp: 'datepicker.time.picker.padding.bottom', read: { path: 'components.datepicker.timePicker.padding', index: 2 } },
  { label: 'datepicker.timePicker.paddingLeft', group: 'CC', exp: 'datepicker.time.picker.padding.left', read: { path: 'components.datepicker.timePicker.padding', index: 3 } },
  { label: 'fieldset.legend.paddingY', group: 'CC', exp: 'fieldset.legend.padding.y', read: { path: 'components.fieldset.legend.padding', index: 0 } },
  { label: 'fieldset.legend.paddingX', group: 'CC', exp: 'fieldset.legend.padding.x', read: { path: 'components.fieldset.legend.padding', index: 1 } },
  { label: 'fileupload.content.paddingTop', group: 'CC', exp: 'fileupload.content.padding.top', read: { path: 'components.fileupload.content.padding', index: 0 } },
  { label: 'fileupload.content.paddingRight', group: 'CC', exp: 'fileupload.content.padding.right', read: { path: 'components.fileupload.content.padding', index: 1 } },
  { label: 'fileupload.content.paddingBottom', group: 'CC', exp: 'fileupload.content.padding.bottom', read: { path: 'components.fileupload.content.padding', index: 2 } },
  { label: 'fileupload.content.paddingLeft', group: 'CC', exp: 'fileupload.content.padding.left', read: { path: 'components.fileupload.content.padding', index: 3 } },
  { label: 'floatlabel.on.active.paddingY', group: 'CC', exp: 'floatlabel.on.active.padding.y', read: { path: 'components.floatlabel.on.active.padding', index: 0 } },
  { label: 'floatlabel.on.active.paddingX', group: 'CC', exp: 'floatlabel.on.active.padding.x', read: { path: 'components.floatlabel.on.active.padding', index: 1 } },
  { label: 'galleria.thumbnailsContent.paddingY', group: 'CC', exp: 'galleria.thumbnails.content.padding.y', read: { path: 'components.galleria.thumbnailsContent.padding', index: 0 } },
  { label: 'galleria.thumbnailsContent.paddingX', group: 'CC', exp: 'galleria.thumbnails.content.padding.x', read: { path: 'components.galleria.thumbnailsContent.padding', index: 1 } },
  { label: 'megamenu.root.horizontalOrientation.paddingY', group: 'CC', exp: 'megamenu.horizontal.orientation.padding.y', read: { path: 'components.megamenu.root.horizontalOrientation.padding', index: 0 } },
  { label: 'megamenu.root.horizontalOrientation.paddingX', group: 'CC', exp: 'megamenu.horizontal.orientation.padding.x', read: { path: 'components.megamenu.root.horizontalOrientation.padding', index: 1 } },
  { label: 'menubar.root.paddingY', group: 'CC', exp: 'menubar.padding.y', read: { path: 'components.menubar.root.padding', index: 0 } },
  { label: 'menubar.root.paddingX', group: 'CC', exp: 'menubar.padding.x', read: { path: 'components.menubar.root.padding', index: 1 } },
  { label: 'message.content.paddingY', group: 'CC', exp: 'message.content.padding.y', read: { path: 'components.message.content.padding', index: 0 } },
  { label: 'message.content.paddingX', group: 'CC', exp: 'message.content.padding.x', read: { path: 'components.message.content.padding', index: 1 } },
  { label: 'message.content.sm.paddingY', group: 'CC', exp: 'message.content.sm.padding.y', read: { path: 'components.message.content.sm.padding', index: 0 } },
  { label: 'message.content.sm.paddingX', group: 'CC', exp: 'message.content.sm.padding.x', read: { path: 'components.message.content.sm.padding', index: 1 } },
  { label: 'message.content.lg.paddingY', group: 'CC', exp: 'message.content.lg.padding.y', read: { path: 'components.message.content.lg.padding', index: 0 } },
  { label: 'message.content.lg.paddingX', group: 'CC', exp: 'message.content.lg.padding.x', read: { path: 'components.message.content.lg.padding', index: 1 } },
  { label: 'organizationchart.node.paddingY', group: 'CC', exp: 'organizationchart.node.padding.y', read: { path: 'components.organizationchart.node.padding', index: 0 } },
  { label: 'organizationchart.node.paddingX', group: 'CC', exp: 'organizationchart.node.padding.x', read: { path: 'components.organizationchart.node.padding', index: 1 } },
  { label: 'organizationchart.node.toggleablePaddingTop', group: 'CC', exp: 'organizationchart.node.toggleable.padding.top', read: { path: 'components.organizationchart.node.toggleablePadding', index: 0 } },
  { label: 'organizationchart.node.toggleablePaddingRight', group: 'CC', exp: 'organizationchart.node.toggleable.padding.right', read: { path: 'components.organizationchart.node.toggleablePadding', index: 1 } },
  { label: 'organizationchart.node.toggleablePaddingBottom', group: 'CC', exp: 'organizationchart.node.toggleable.padding.bottom', read: { path: 'components.organizationchart.node.toggleablePadding', index: 2 } },
  { label: 'organizationchart.node.toggleablePaddingLeft', group: 'CC', exp: 'organizationchart.node.toggleable.padding.left', read: { path: 'components.organizationchart.node.toggleablePadding', index: 3 } },
  { label: 'paginator.root.paddingY', group: 'CC', exp: 'paginator.padding.y', read: { path: 'components.paginator.root.padding', index: 0 } },
  { label: 'paginator.root.paddingX', group: 'CC', exp: 'paginator.padding.x', read: { path: 'components.paginator.root.padding', index: 1 } },
  { label: 'panel.toggleableHeader.paddingY', group: 'CC', exp: 'panel.toggleable.header.padding.y', read: { path: 'components.panel.toggleableHeader.padding', index: 0 } },
  { label: 'panel.toggleableHeader.paddingX', group: 'CC', exp: 'panel.toggleable.header.padding.x', read: { path: 'components.panel.toggleableHeader.padding', index: 1 } },
  { label: 'panel.content.paddingTop', group: 'CC', exp: 'panel.content.padding.top', read: { path: 'components.panel.content.padding', index: 0 } },
  { label: 'panel.content.paddingRight', group: 'CC', exp: 'panel.content.padding.right', read: { path: 'components.panel.content.padding', index: 1 } },
  { label: 'panel.content.paddingBottom', group: 'CC', exp: 'panel.content.padding.bottom', read: { path: 'components.panel.content.padding', index: 2 } },
  { label: 'panel.content.paddingLeft', group: 'CC', exp: 'panel.content.padding.left', read: { path: 'components.panel.content.padding', index: 3 } },
  { label: 'panel.footer.paddingTop', group: 'CC', exp: 'panel.footer.padding.top', read: { path: 'components.panel.footer.padding', index: 0 } },
  { label: 'panel.footer.paddingRight', group: 'CC', exp: 'panel.footer.padding.right', read: { path: 'components.panel.footer.padding', index: 1 } },
  { label: 'panel.footer.paddingBottom', group: 'CC', exp: 'panel.footer.padding.bottom', read: { path: 'components.panel.footer.padding', index: 2 } },
  { label: 'panel.footer.paddingLeft', group: 'CC', exp: 'panel.footer.padding.left', read: { path: 'components.panel.footer.padding', index: 3 } },
  { label: 'stepper.separator.marginTop', group: 'CC', exp: 'stepper.separator.margin.top', read: { path: 'components.stepper.separator.margin', index: 0 } },
  { label: 'stepper.separator.marginRight', group: 'CC', exp: 'stepper.separator.margin.right', read: { path: 'components.stepper.separator.margin', index: 1 } },
  { label: 'stepper.separator.marginBottom', group: 'CC', exp: 'stepper.separator.margin.bottom', read: { path: 'components.stepper.separator.margin', index: 2 } },
  { label: 'stepper.separator.marginLeft', group: 'CC', exp: 'stepper.separator.margin.left', read: { path: 'components.stepper.separator.margin', index: 3 } },
  { label: 'stepper.steppanels.paddingTop', group: 'CC', exp: 'stepper.steppanels.padding.top', read: { path: 'components.stepper.steppanels.padding', index: 0 } },
  { label: 'stepper.steppanels.paddingRight', group: 'CC', exp: 'stepper.steppanels.padding.right', read: { path: 'components.stepper.steppanels.padding', index: 1 } },
  { label: 'stepper.steppanels.paddingBottom', group: 'CC', exp: 'stepper.steppanels.padding.bottom', read: { path: 'components.stepper.steppanels.padding', index: 2 } },
  { label: 'stepper.steppanels.paddingLeft', group: 'CC', exp: 'stepper.steppanels.padding.left', read: { path: 'components.stepper.steppanels.padding', index: 3 } },
  { label: 'tag.root.paddingY', group: 'CC', exp: 'tag.padding.y', read: { path: 'components.tag.root.padding', index: 0 } },
  { label: 'tag.root.paddingX', group: 'CC', exp: 'tag.padding.x', read: { path: 'components.tag.root.padding', index: 1 } },
  { label: 'timeline.horizontal.eventContent.paddingY', group: 'CC', exp: 'timeline.horizontal.event.content.padding.y', read: { path: 'components.timeline.horizontal.eventContent.padding', index: 0 } },
  { label: 'timeline.horizontal.eventContent.paddingX', group: 'CC', exp: 'timeline.horizontal.event.content.padding.x', read: { path: 'components.timeline.horizontal.eventContent.padding', index: 1 } },
  { label: 'timeline.vertical.eventContent.paddingY', group: 'CC', exp: 'timeline.vertical.event.content.padding.y', read: { path: 'components.timeline.vertical.eventContent.padding', index: 0 } },
  { label: 'timeline.vertical.eventContent.paddingX', group: 'CC', exp: 'timeline.vertical.event.content.padding.x', read: { path: 'components.timeline.vertical.eventContent.padding', index: 1 } },
  { label: 'togglebutton.content.paddingY', group: 'CC', exp: 'togglebutton.content.padding.y', read: { path: 'components.togglebutton.content.padding', index: 0 } },
  { label: 'togglebutton.content.paddingX', group: 'CC', exp: 'togglebutton.content.padding.x', read: { path: 'components.togglebutton.content.padding', index: 1 } },
  { label: 'togglebutton.content.sm.paddingY', group: 'CC', exp: 'togglebutton.content.sm.padding.y', read: { path: 'components.togglebutton.content.sm.padding', index: 0 } },
  { label: 'togglebutton.content.sm.paddingX', group: 'CC', exp: 'togglebutton.content.sm.padding.x', read: { path: 'components.togglebutton.content.sm.padding', index: 1 } },
  { label: 'togglebutton.content.lg.paddingY', group: 'CC', exp: 'togglebutton.content.lg.padding.y', read: { path: 'components.togglebutton.content.lg.padding', index: 0 } },
  { label: 'togglebutton.content.lg.paddingX', group: 'CC', exp: 'togglebutton.content.lg.padding.x', read: { path: 'components.togglebutton.content.lg.padding', index: 1 } },
  { label: 'tree.node.paddingY', group: 'CC', exp: 'tree.node.padding.y', read: { path: 'components.tree.node.padding', index: 0 } },
  { label: 'tree.node.paddingX', group: 'CC', exp: 'tree.node.padding.x', read: { path: 'components.tree.node.padding', index: 1 } },
  { label: 'treetable.header.paddingY', group: 'CC', exp: 'treetable.header.padding.y', read: { path: 'components.treetable.header.padding', index: 0 } },
  { label: 'treetable.header.paddingX', group: 'CC', exp: 'treetable.header.padding.x', read: { path: 'components.treetable.header.padding', index: 1 } },
  { label: 'treetable.headerCell.paddingY', group: 'CC', exp: 'treetable.header.cell.padding.y', read: { path: 'components.treetable.headerCell.padding', index: 0 } },
  { label: 'treetable.headerCell.paddingX', group: 'CC', exp: 'treetable.header.cell.padding.x', read: { path: 'components.treetable.headerCell.padding', index: 1 } },
  { label: 'treetable.bodyCell.paddingY', group: 'CC', exp: 'treetable.body.cell.padding.y', read: { path: 'components.treetable.bodyCell.padding', index: 0 } },
  { label: 'treetable.bodyCell.paddingX', group: 'CC', exp: 'treetable.body.cell.padding.x', read: { path: 'components.treetable.bodyCell.padding', index: 1 } },
  { label: 'treetable.footerCell.paddingY', group: 'CC', exp: 'treetable.footer.cell.padding.y', read: { path: 'components.treetable.footerCell.padding', index: 0 } },
  { label: 'treetable.footerCell.paddingX', group: 'CC', exp: 'treetable.footer.cell.padding.x', read: { path: 'components.treetable.footerCell.padding', index: 1 } },
  { label: 'treetable.footer.paddingY', group: 'CC', exp: 'treetable.footer.padding.y', read: { path: 'components.treetable.footer.padding', index: 0 } },
  { label: 'treetable.footer.paddingX', group: 'CC', exp: 'treetable.footer.padding.x', read: { path: 'components.treetable.footer.padding', index: 1 } },
];
