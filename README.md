...
| `@smartcontact-hub/components` | [`projects/ui-smartcontact`](projects/ui-smartcontact/README.md)             | `provideSmartContactUi()`, el preset modular (`theme/sc-preset`, cada slot a `var(--sc-*)`) y 56 componentes `sc-*` ([inventario](docs/inventory.md)) |
