export default {
    ...
    highlight: {
        background: "light-dark({primary.50}, #34d39929)",
        focusBackground: "light-dark({primary.100}, #34d3993d)",
        color: "light-dark({primary.700}, #ffffffde)",
        focusColor: "light-dark({primary.800}, #ffffffde)"
    },
    formField: {
        paddingX: "0.75rem",
        paddingY: "0.5rem",
        ...
        floatLabelFocusColor: "light-dark({surface.500}, {surface.400})",
    ...
    text: {
        ...
        mutedColor: "light-dark({slate.600}, {surface.400})",
