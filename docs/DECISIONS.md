...
> | Tema | DD |
> |---|---|
> | TopBar y bloque del logo con el mismo `scale/4` (56) · tallas de dentro con tokens del DS · barra → título `1-25`, lados `2`, buscador → tabla `0-875` · una barra `sticky` necesita que ningún antepasado tenga `overflow: auto` | DD-93 |
...
## DD-93 · 2026-09-14 — La cabecera y el bloque del logo miden 56 con el mismo token, y todas las listas reparten el aire igual
