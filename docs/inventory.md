...
| `sc-button` | EXTENDED | primeng/button | 15 inputs | — | ✓ | 129 |
...
| `sc-datatable` | EXTENDED | primeng/table | 29 inputs | — | ✓ | 13 |
...
| `sc-divider` | STANDARD | primeng/divider | 3 inputs | — | ✓ | 28 |
...
| `sc-inputnumber` | EXTENDED | primeng/inputtext | 16 inputs | sc-field-label sc-field-msg | ✓ | 17 |
...
| `sc-select` | EXTENDED | primeng/select | 28 inputs | sc-field-label sc-field-msg | ✓ | 36 |
| `sc-selectbutton` | EXTENDED | primeng/selectbutton | 13 inputs | — | ✓ | 8 |
...
| `sc-toggleswitch` | EXTENDED | primeng/toggleswitch | 7 inputs | — | ✓ | 23 |
