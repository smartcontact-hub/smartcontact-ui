...
| `sc-button` | EXTENDED | primeng/button | 15 inputs | — | ✓ | 144 |
...
| `sc-dialog` | EXTENDED | primeng/dialog | 14 inputs | — | ✓ | 15 |
| `sc-divider` | STANDARD | primeng/divider | 3 inputs | — | ✓ | 32 |
...
| `sc-photo-upload` | CUSTOM | — | 6 inputs | — | ✓ | 3 |
...
| `sc-select` | EXTENDED | primeng/select | 28 inputs | sc-field-label sc-field-msg | ✓ | 41 |
| `sc-selectbutton` | EXTENDED | primeng/selectbutton | 13 inputs | — | ✓ | 14 |
