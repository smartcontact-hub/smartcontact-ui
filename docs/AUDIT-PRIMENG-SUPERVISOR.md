...
**568 props** que PrimeNG sí documenta.
...
### `sc-select` · 39 usos · primeng/select
...
### `sc-button` · 143 usos · primeng/button
...
### `sc-drawer` · 5 usos · primeng/drawer
...
### `sc-divider` · 32 usos · primeng/divider
