...
- Name: components.spec.ts >> sc-panel >> métrica del Kit (header 15.75, radio 6)
- Location: e2e/components.spec.ts:158:7
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  827576 pixels (ratio 0.90 of all image pixels) are different.
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e10]:
      - generic [ref=e11]:
        - heading "sc-panel" [level=1] [ref=e12]
        - generic [ref=e13]:
          - generic [ref=e15]:
            - generic [ref=e17]: Panel básico
            - region "Panel básico" [ref=e18]:
              - generic [ref=e20]: Contenido del panel.
          - generic [ref=e22]:
            - generic [ref=e23]:
              - generic [ref=e24]: Colapsable
              - button "Colapsable" [expanded] [ref=e26]:
                - button [ref=e27] [cursor=pointer]:
                  - img [ref=e28]
            - region "Colapsable" [ref=e30]:
              - generic [ref=e32]: Contenido colapsable.
  - iframe [ref=e33]:
    - generic [ref=f1e2]:
