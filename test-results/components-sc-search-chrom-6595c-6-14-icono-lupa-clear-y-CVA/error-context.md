...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  823569 pixels (ratio 0.90 of all image pixels) are different.

  Snapshot: search.png

Call log:
  - Expect "toHaveScreenshot(search.png)" with timeout 5000ms
...
- generic [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e10]:
      - generic [ref=e11]:
        - heading "sc-search" [level=1] [ref=e12]
        - generic [ref=e13]:
          - generic [ref=e15]:
            - generic [ref=e18]: search
            - searchbox "Buscar agentes…" [active] [ref=e19]: hola
            - button "Clear search" [ref=e20] [cursor=pointer]:
              - generic [ref=e22]: close
          - generic [ref=e24]:
            - generic [ref=e27]: search
            - searchbox "Con atajo" [ref=e28]
            - generic: ⌘K
          - generic [ref=e30]:
            - generic [ref=e33]: search
            - searchbox "Small" [ref=e34]
          - generic [ref=e36]:
            - generic [ref=e39]: search
            - searchbox "Deshabilitado" [disabled] [ref=e40]
        - paragraph [ref=e41]: "Término: «hola»"
  - iframe [ref=e42]:
    - generic [ref=f1e2]:
