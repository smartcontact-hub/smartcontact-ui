...
- Name: components.spec.ts >> sc-progressbar >> métrica del Kit (alto 17.5, radio 6, label 12)
- Location: e2e/components.spec.ts:212:7
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  815580 pixels (ratio 0.89 of all image pixels) are different.

  Snapshot: progressbar.png

Call log:
  - Expect "toHaveScreenshot(progressbar.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e10]:
      - generic [ref=e11]:
        - heading "sc-progressbar" [level=1] [ref=e12]
        - generic [ref=e13]:
          - progressbar [ref=e15]:
            - generic [ref=e18]: 40%
          - progressbar [ref=e20]
