...
- Name: components.spec.ts >> sc-divider >> métrica del Kit (margin 14, content padding 7) y variantes
- Location: e2e/components.spec.ts:280:7
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  826917 pixels (ratio 0.90 of all image pixels) are different.

  Snapshot: divider.png

Call log:
  - Expect "toHaveScreenshot(divider.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e10]:
      - generic [ref=e11]:
        - heading "sc-divider" [level=1] [ref=e12]
        - generic [ref=e13]:
          - text: Texto antes del separador.
          - generic:
            - separator
          - text: Texto después.
          - separator [ref=e15]:
          ...
          - generic:
            - separator
        - heading "Vertical" [level=2] [ref=e17]
        - generic [ref=e18]:
          - text: Izquierda
          - generic:
            - separator
