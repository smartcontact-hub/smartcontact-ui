...
- Name: components.spec.ts >> sc-inputnumber >> métrica de form field + chrome de error
- Location: e2e/components.spec.ts:348:7
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  824322 pixels (ratio 0.90 of all image pixels) are different.

  Snapshot: inputnumber.png

Call log:
  - Expect "toHaveScreenshot(inputnumber.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e10]:
      - generic [ref=e11]:
        - heading "sc-inputnumber" [level=1] [ref=e12]
        - generic [ref=e13]:
          - generic [ref=e14]:
            - generic [ref=e15]: Cantidad
            - spinbutton "Cantidad" [ref=e17]
          - generic [ref=e18]:
            - generic [ref=e19]: Con límites
            - spinbutton "Con límites" [ref=e21]
          - generic [ref=e22]:
            - generic [ref=e23]: Con error
            - spinbutton "Con error" [ref=e25]
            - generic [ref=e26]: Fuera de rango
          - generic [ref=e27]:
            - generic [ref=e28]: Deshabilitado
            - spinbutton "Deshabilitado" [disabled] [ref=e30]
  - iframe [ref=e31]:
    - generic [ref=f1e2]:
