...
- Name: components.spec.ts >> sc-chip >> métrica del Kit (10.5/7, radio 16, gap 7)
- Location: e2e/components.spec.ts:103:7
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  827478 pixels (ratio 0.90 of all image pixels) are different.

  Snapshot: chip.png

Call log:
  - Expect "toHaveScreenshot(chip.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e10]:
      - generic [ref=e11]:
        - heading "sc-chip" [level=1] [ref=e12]
        - generic [ref=e13]:
          - generic "Etiqueta" [ref=e15]:
            - generic [ref=e16]: Etiqueta
          - generic "Con icono" [ref=e18]:
            - generic [ref=e19]: check
            - generic [ref=e20]: Con icono
          - generic "Quitable" [ref=e22]:
            - generic [ref=e23]: Quitable
            - button "Remove" [ref=e24] [cursor=pointer]
          - generic [ref=e27]:
            - generic "Deshabilitado":
              - generic: Deshabilitado
  - iframe [ref=e28]:
    - generic [ref=f1e2]:
