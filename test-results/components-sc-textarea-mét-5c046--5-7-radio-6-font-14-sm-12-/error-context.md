...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  825330 pixels (ratio 0.79 of all image pixels) are different.

  Snapshot: textarea.png

Call log:
  - Expect "toHaveScreenshot(textarea.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e10]:
      - generic [ref=e11]:
        - heading "sc-textarea" [level=1] [ref=e12]
        - generic [ref=e13]:
          - textbox "Escribe aquí…" [ref=e15]
          - textbox "Auto-resize" [ref=e17]
          - textbox "Small" [ref=e19]
          - textbox "Large" [ref=e21]
          - textbox "Inválido" [ref=e23]
          - textbox "Deshabilitado" [disabled] [ref=e25]
          - textbox "Fluid" [ref=e27]
  - iframe [ref=e28]:
    - generic [ref=f1e2]:
