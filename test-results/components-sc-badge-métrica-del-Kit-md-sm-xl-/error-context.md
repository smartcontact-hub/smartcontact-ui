...
- Name: components.spec.ts >> sc-badge >> métrica del Kit (md/sm/xl)
- Location: e2e/components.spec.ts:70:7
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  824711 pixels (ratio 0.90 of all image pixels) are different.

  Snapshot: badge.png

Call log:
  - Expect "toHaveScreenshot(badge.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e10]:
      - generic [ref=e11]:
        - heading "sc-badge" [level=1] [ref=e12]
        ...
        - generic [ref=e14]:
          ...
          - generic [ref=e26]: 9+
          - generic [ref=e28]: C
        - heading "Tamaños" [level=2] [ref=e29]
        - generic [ref=e30]:
          - generic [ref=e32]: s
          - generic [ref=e34]: m
          - generic [ref=e36]: l
