...
- Name: components.spec.ts >> sc-skeleton >> radio del Kit (6) y animación
- Location: e2e/components.spec.ts:169:7
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  827680 pixels (ratio 0.90 of all image pixels) are different.

  Snapshot: skeleton.png

Call log:
  - Expect "toHaveScreenshot(skeleton.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e10]:
      - heading "sc-skeleton" [level=1] [ref=e12]
  - iframe [ref=e24]:
    - generic [ref=f1e2]:
