...
- Name: components.spec.ts >> sc-confirmdialog >> abre con métrica del Kit, resuelve la Promise y respeta tonos
- Location: e2e/components.spec.ts:410:7
...
Call log:
  - waiting for getByTestId('confirm-danger').locator('button')
    - locator resolved to <button pc6="" pc7="" pc8="" data-p="" pripple="" type="button" autofocus="true" data-pc-name="button" data-pc-section="root" data-p-severity="danger" class="p-ripple p-button p-button-danger p-component">…</button>
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e10]:
      - generic [ref=e11]:
        - heading "sc-confirmdialog" [level=1] [ref=e12]
        - generic:
          - generic:
            - alertdialog
        - generic [ref=e13]:
          - button "Confirmación primaria" [ref=e16] [cursor=pointer]:
            - generic [ref=e17]: Confirmación primaria
          - button "Destructiva" [ref=e20] [cursor=pointer]:
            - generic [ref=e21]: Destructiva
          - button "Descartar cambios (énfasis reject)" [ref=e24] [cursor=pointer]:
            - generic [ref=e25]: Descartar cambios (énfasis reject)
        - paragraph [ref=e26]: "Resultado: —"
  - iframe [ref=e27]:
    - generic [ref=f1e2]:
