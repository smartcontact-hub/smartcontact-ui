...
- Name: components.spec.ts >> sc-toast >> muestra el toast con tipografía del Kit (14/12)
- Location: e2e/components.spec.ts:268:7
...
Call log:
  - waiting for getByTestId('toast-success').locator('button')
    - locator resolved to <button pc2="" pc3="" pc4="" data-p="" pripple="" type="button" autofocus="true" data-pc-name="button" data-pc-section="root" data-p-severity="success" class="p-ripple p-button p-button-success p-component">…</button>
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e10]:
      - generic [ref=e11]:
        - heading "sc-toast" [level=1] [ref=e12]
        - generic [ref=e13]:
          - button "Success" [ref=e16] [cursor=pointer]:
            - generic [ref=e17]: Success
          - button "Info" [ref=e20] [cursor=pointer]:
            - generic [ref=e21]: Info
          - button "Warn" [ref=e24] [cursor=pointer]:
            - generic [ref=e25]: Warn
          - button "Danger" [ref=e28] [cursor=pointer]:
            - generic [ref=e29]: Danger
  - iframe [ref=e30]:
    - generic [ref=f1e2]:
