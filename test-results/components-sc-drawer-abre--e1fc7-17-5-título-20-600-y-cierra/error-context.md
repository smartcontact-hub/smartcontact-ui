...
- Name: components.spec.ts >> sc-drawer >> abre, renderiza cabecera del Kit (17.5, título 20/600) y cierra
- Location: e2e/components.spec.ts:194:7
...
Call log:
  - waiting for getByTestId('open-drawer').locator('button')
    - locator resolved to <button pc1="" pc2="" pc3="" data-p="" pripple="" type="button" autofocus="true" data-pc-name="button" data-pc-section="root" data-p-severity="primary" class="p-ripple p-button p-button-primary p-component">…</button>
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e10]:
      - generic [ref=e11]:
        - heading "sc-drawer" [level=1] [ref=e12]
        - button "Abrir drawer" [ref=e16] [cursor=pointer]:
          - generic [ref=e17]: Abrir drawer
  - iframe [ref=e18]:
    - generic [ref=f1e2]:
