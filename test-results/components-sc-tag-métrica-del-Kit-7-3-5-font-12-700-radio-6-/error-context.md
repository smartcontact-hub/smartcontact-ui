...
- Name: components.spec.ts >> sc-tag >> métrica del Kit (7/3.5, font 12/700, radio 6)
- Location: e2e/components.spec.ts:118:7
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  824770 pixels (ratio 0.90 of all image pixels) are different.

  Snapshot: tag.png

Call log:
  - Expect "toHaveScreenshot(tag.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e10]:
      - generic [ref=e11]:
        - heading "sc-tag" [level=1] [ref=e12]
        - heading "Severities" [level=2] [ref=e13]
        - generic [ref=e14]:
          - generic [ref=e17]: Primary
          - generic [ref=e20]: Secondary
          - generic [ref=e23]: Success
          - generic [ref=e26]: Info
          - generic [ref=e29]: Warn
          - generic [ref=e32]: Danger
          - generic [ref=e35]: Contrast
        - heading "Variantes" [level=2] [ref=e36]
        - generic [ref=e37]:
          - generic [ref=e40]: Rounded
          - generic [ref=e42]:
            - generic [ref=e43]: check
            - generic [ref=e44]: Con icono
  - iframe [ref=e45]:
    - generic [ref=f1e2]:
