...
- Name: components.spec.ts >> sc-card >> métrica del Kit (body 17.5, radio 12)
- Location: e2e/components.spec.ts:89:7
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  823203 pixels (ratio 0.90 of all image pixels) are different.

  Snapshot: card.png

Call log:
  - Expect "toHaveScreenshot(card.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e10]:
      - generic [ref=e11]:
        - heading "sc-card" [level=1] [ref=e12]
        - generic [ref=e13]:
          - generic [ref=e16]:
            - generic [ref=e17]: Título de card
            - generic [ref=e18]: Subtítulo
            - generic [ref=e19]: Contenido proyectado de la tarjeta. Hereda tipografía y tokens del tema.
          - generic [ref=e23]: Sin cabecera — solo contenido.
  - iframe [ref=e24]:
    - generic [ref=f1e2]:
